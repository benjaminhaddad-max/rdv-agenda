...
export default function ResourcesPanel({ onClose, role }: Props) {
  ...
  return (
    ...
    >
      <div style={{
        background: '#f7f4ee', border: '1px solid #e5ddc8', borderRadius: 20,
        ...
        {/* Header */}
        <div style={{
          padding: '20px 24px', borderBottom: '1px solid #e5ddc8',
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          flexShrink: 0,
        }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <span style={{ fontSize: 22 }}>📦</span>
            <span style={{ fontSize: 16, fontWeight: 700, color: '#0e1e35' }}>
              {ROLE_TITLES[role]}
            </span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <button
              onClick={onClose}
              style={{
                background: 'rgba(255,255,255,0.06)', border: '1px solid #e5ddc8',
                borderRadius: 8, padding: 6, cursor: 'pointer', color: '#4a6070',
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 24px 24px' }}>
            ...
            <div style={{
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: 8, padding: '10px 14px', color: '#0e1e35',
              ...
              <div style={{ display: 'flex', gap: 10, marginBottom: 12 }}>
                ...
                <input
                  ...
                  placeholder="Ordre"
                  style={{
                    width: 70, background: '#f7f4ee', border: '1px solid #e5ddc8',
                    borderRadius: 8, padding: '10px 14px', color: '#0e1e35',
              ...
              <div style={{ marginBottom: 16 }}>
                <span style={{ fontSize: 11, color: '#4a6070', fontWeight: 600, marginBottom: 6, display: 'block' }}>
                  Visible par :
                </span>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button
                  onClick={resetForm}
                  style={{
                    background: 'rgba(255,255,255,0.04)', border: '1px solid #e5ddc8',
                    borderRadius: 8, padding: '8px 20px', color: '#4a6070',
          ...
          {/* Loading */}
          {loading && (
            <div style={{ textAlign: 'center', padding: 40, color: '#4a6070', fontSize: 13 }}>
              Chargement…
            </div>
          )}
          ...
          {Object.entries(grouped).map(([cat, items]) => (
            <div key={cat} style={{ marginBottom: 20 }}>
              <div style={{
                fontSize: 12, fontWeight: 700, color: '#4a6070',
                ...
                {items.map(r => (
                  <div key={r.id} style={{
                    ...
                    >
                      ...
                      {/* Title */}
                      <span style={{ flex: 1, fontSize: 13, fontWeight: 600, color: '#0e1e35' }}>
                        {r.title}
                      </span>

                      {/* Type badge */}
                      <span style={{
                        fontSize: 10, fontWeight: 700, color: '#4a6070',
                      ...
                      {r.type === 'text' && (
                        <span style={{ color: '#4a6070', display: 'flex', alignItems: 'center' }}>
                      ...
                      {isAdmin && (
                        <div style={{ display: 'flex', gap: 4, marginLeft: 4 }} onClick={e => e.stopPropagation()}>
                          <button
                            ...
                            style={{
                              background: 'rgba(255,255,255,0.04)', border: '1px solid #e5ddc8',
                              borderRadius: 6, padding: 4, cursor: 'pointer', color: '#4a6070',
                              display: 'flex', alignItems: 'center',
                            }}
                          >
                            <Edit3 size={12} />
                      ...
                      <div style={{
                        ...
                        <button
                          ...
                          style={{
                            ...
                            border: `1px solid ${copiedId === r.id ? 'rgba(34,197,94,0.3)' : '#e5ddc8'}`,
                            borderRadius: 6, padding: '5px 12px',
                            color: copiedId === r.id ? '#22c55e' : '#4a6070',
        ...
        {/* Footer */}
        <div style={{
          padding: '12px 24px', borderTop: '1px solid #e5ddc8',
