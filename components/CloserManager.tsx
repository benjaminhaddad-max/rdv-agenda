      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <div style={{ fontWeight: 700, fontSize: 15, color: '#1e293b' }}>Équipe Closers</div>
        ...
        <div style={{ padding: '20px', flex: 1 }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button
                  ...
                  style={{
                    flex: 1, background: (addFirstName.trim() && addLastName.trim() && addEmail.trim()) ? '#ccac71' : '#f1f5f9',
                    color: (addFirstName.trim() && addLastName.trim() && addEmail.trim()) ? '#f8fafc' : '#64748b',
          ...
          {loading ? (
            ...
            <>
              ...
              {active.length === 0 ? (
                <div style={{ fontSize: 13, color: '#64748b', marginBottom: 20 }}>Aucun closer actif.</div>
              ) : (
...
function CloserRow({
  ...
  return (
    <div style={{
      background: '#e2e8f0',
      border: `1px solid ${cl.is_banned ? 'rgba(239,68,68,0.15)' : '#e2e8f0'}`,
        ...
        <>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div style={{
              ...
              color: cl.is_banned ? '#64748b' : cl.avatar_color,
            }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontWeight: 700, fontSize: 13, color: cl.is_banned ? '#64748b' : '#1e293b' }}>
                {cl.name}
              </div>
