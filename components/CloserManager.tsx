        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{
              ...
              <Briefcase size={15} style={{ color: '#ccac71' }} />
            </div>
            <div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button
                  ...
                  style={{
                    flex: 1, background: (addFirstName.trim() && addLastName.trim() && addEmail.trim()) ? '#ccac71' : '#243d5c',
                    color: (addFirstName.trim() && addLastName.trim() && addEmail.trim()) ? '#0b1624' : '#555870',
...
function CloserRow({
  ...
  return (
    <div style={{
      background: '#152438',
      border: `1px solid ${cl.is_banned ? 'rgba(239,68,68,0.15)' : '#2d4a6b'}`,
