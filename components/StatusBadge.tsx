...
const STATUS_CONFIG = {
  ...
  a_travailler:  { label: 'A travailler',  color: '#C9A84C', bg: 'rgba(204,172,113,0.12)', border: 'rgba(204,172,113,0.3)' },
  ...
  va_reflechir:  { label: 'Va réfléchir',  color: '#C9A84C', bg: 'rgba(204,172,113,0.12)', border: 'rgba(204,172,113,0.3)' },
