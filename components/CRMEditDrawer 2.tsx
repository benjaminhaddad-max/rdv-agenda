...
function EditField({
  ...
  return (
    <div style={{ marginBottom: 12 }}>
      <div style={{ fontSize: 10, color: '#0F1F3D', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 4 }}>{label}</div>
      {editing ? (
        ...
        >
          <span>{value || '—'}</span>
          <span style={{ fontSize: 10, color: '#0F1F3D' }}>✎</span>
        </div>
      )}
    </div>
  )
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '20px' }}>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontSize: 10, color: '#0F1F3D', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 4 }}>Date de création</div>
            ...
            {/* Origine (read-only) */}
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontSize: 10, color: '#0F1F3D', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 4 }}>Origine</div>
              <div style={{ padding: '7px 10px', background: 'rgba(255,255,255,0.02)', border: `1px solid ${NAVY_BORDER}`, borderRadius: 6, fontSize: 12 }}>
                {sourceLabel ? (
                  ...
                  <span style={{ color: '#0F1F3D' }}>—</span>
                )}
              </div>
            </div>
            {/* Soumission de formulaire (read-only) */}
            <div style={{ marginBottom: 12 }}>
              <div style={{ fontSize: 10, color: '#0F1F3D', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 4 }}>Soumission formulaire</div>
              <div style={{ padding: '7px 10px', background: 'rgba(255,255,255,0.02)', border: `1px solid ${NAVY_BORDER}`, borderRadius: 6, fontSize: 12 }}>
          ...
          {deal && (
            <div style={{ marginBottom: 24 }}>
              ...
              {deal.formation && (
                <div style={{ marginBottom: 12 }}>
                  <div style={{ fontSize: 10, color: '#0F1F3D', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 4 }}>Formation</div>
              ...
              {deal.closedate && (
                <div style={{ marginBottom: 12 }}>
                  <div style={{ fontSize: 10, color: '#0F1F3D', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 4 }}>Date RDV</div>
