...
export const LAST_CHANCE_SUBJECTS: Record<string, string> = {
  ...
  J2: 'PASS / LAS : Tutorat ou prépa ?',
  J3: 'Installe ta méthode avant le PASS / LAS',
...
export const LAST_CHANCE_MEDECINE_STEPS: LastChanceStepDef[] = [
  ...
  },
  {
    ...
    preheader: 'Prépa complète, tutorat ciblé ou les deux — fais le bon arbitrage avant septembre.',
    paragraphs: [
      'Tu as ta place en PASS/LAS pour septembre. Beaucoup hésitent encore entre <strong>prépa complète</strong>, <strong>tutorat seul</strong> ou <strong>les deux</strong> — alors que les places et les formules se remplissent.',
      'Une prépa annuelle à Paris, c\'est du cadre, des colles et un volume de QCM — mais plusieurs milliers d\'euros. Un tutorat ciblé ou des colles à la carte, c\'est souvent moins cher — mais ce n\'est pas la même couverture ni le même suivi.',
      'L\'erreur classique : payer une prépa complète alors qu\'un tutorat suffirait — ou l\'inverse, rester seul alors qu\'il manque de la structure pour <strong>ta fac</strong> (' + PARIS_FACS_LIST + ').',
      '<strong>Numerus Club</strong> te met en relation avec des étudiants ayant réussi le concours dans une fac parisienne — pour t\'aider à trancher : prépa, tutorat, combo, ou autonomie assumée.',
      'Dis-nous en 2 minutes ta fac, ton cursus (PASS/LAS) et où tu en es : prépa signée, tutorat seul, les deux, ou pas encore décidé.',
    ],
