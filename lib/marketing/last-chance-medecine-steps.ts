...
export const LAST_CHANCE_MEDECINE_STEPS: LastChanceStepDef[] = [
  ...
  },
  {
    ...
    ctaLabel: 'Faire le point avec un étudiant PASS/LAS →',
    ctaHref: 'https://www.numerusclub.fr',
    showFormLink: true,
    formLinkLabel: 'Je précise mon profil PASS/LAS (2 min) →',
  },
  {
    brand: 'hermione',
    label: 'J3',
    ...
    ctaLabel: 'Structurer ma méthode avant la rentrée →',
    ctaHref: 'https://hermione.co',
    showFormLink: true,
    formLinkLabel: 'Je précise si j\'ai une prépa ou non (2 min) →',
  },
  {
    brand: 'prepamedecine',
    label: 'J4',
    ...
    ctaLabel: 'Recevoir mon comparatif prépa sous 24 h →',
    ctaHref: 'https://prepamedecine.fr',
    showFormLink: true,
    formLinkLabel: 'Je précise ma fac et mon budget (2 min) →',
  },
  {
    brand: 'afem',
    label: 'J5',
  ...
  },
  {
    ...
    ctaLabel: 'Comparer les prépas par ville et budget →',
    ctaHref: 'https://prepamedecine.fr',
    showFormLink: true,
